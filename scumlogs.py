...
# - Fixed the log retrieval error.
# - The script does now continue each log in a single file instead of keep making chunks like G-portal stores them.
# Updated by Zodiac script originally created by Sergiocr.
